...
export const text = {
  ...
  Tag: "Từ khoá",
  TagDesc: "Thêm tối đa 5 Từ khoá liên quan đến câu hỏi",
  FieldRequierd: "Trường này không thể bỏ trống",
  FieldLengthRequierd: "Trường cần tối thiêu 6 ký tự",
  TagRequierd: "Trường này chỉ có thể nhận 5 Từ khoá",
  CreateQuestion: "Tạo câu hỏi",
  NoResult: "Không có kết quả",
  TagPageDesc:
    "Từ khoá là một từ khóa hoặc nhãn phân loại câu hỏi của bạn với các câu hỏi tương tự khác",
  NewTag: "Tạo Từ khoá mới",
  Img: "Ảnh minh hoạ",
  AddImg: "Chọn tối đa 3 ảnh để miêu tả câu hỏi",
  ImgMax: "Trường này chỉ nhận tối đa 3 ảnh",
  UserProfile: "Trang cá nhân",
  LogOut: "Đăng xuất",
  Home: "Trang chủ",
  FileSizeErr: "Ảnh quá nặng",
  TagName: "Tên Từ khoá",
  TagNameDesc: "Tên miêu tả Từ khoá",
  TagDescription: "Mô tả nội dung Từ khoá",
  TagDescHint: "Hãy miểu tả cụ thể về Từ khoá này",
  Createtag: "Tạo Từ khoá",
  Comment: "Bình luận",
  ...
  emptyComment: 'Bạn cần nhập nội dung để bình luận',
};
